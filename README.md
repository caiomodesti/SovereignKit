...
> **Status:** v0.1, Sprint 6 complete after the formal **GO** checkpoint. The controlled experiment stack now includes a standalone Observer and a separate, schema-validating, allowlisted, durable local Collector. No intelligence feed, dashboard, public ingestion, or decentralized observer network exists yet.
...
- 54/54 deterministic unit tests plus one standalone-process integration test at the Sprint 6 checkpoint;
