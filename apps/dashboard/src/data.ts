...
export function validateDashboardDataset(value: unknown): DashboardDataset {
  ...
  if (dataset.scenarios.some(scenario => typeof scenario !== "object" || scenario === null || !Array.isArray(scenario.cells) || !Array.isArray(scenario.classifications))) throw new Error("dashboard scenario evidence is incomplete");
