...
[[ ! -e $install_root && ! -e $unit_target && ! -e $env_target ]] || { echo 'M2 host runtime already exists; reconciliation required' >&2; exit 73; }
...
install -d -m 0700 -o sovereignkit -g sovereignkit /var/lib/sovereignkit/m2/inbox /var/lib/sovereignkit/m2/quota /var/lib/sovereignkit/evidence/m2/raw /var/lib/sovereignkit/evidence/m2/completed
