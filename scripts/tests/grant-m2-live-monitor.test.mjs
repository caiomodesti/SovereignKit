...
const healthy = { sampled_at: '2026-09-12T04:10:00.000Z', observer_id: 'observer-google-e2-micro', memory_available_bytes: 600 * 1024 ** 2, disk_free_bytes: 10 * 1024 ** 3, clock_absolute_offset_ms: 10, service_active: true, observer_ready: true, observer_delivered_count: 12, ntp_synchronized: true, consecutive_service_or_ntp_failures: 0, delivery_backlog_count: 0, oldest_delivery_age_seconds: 0, local_rpc_quota_remaining_percent: 100 };
