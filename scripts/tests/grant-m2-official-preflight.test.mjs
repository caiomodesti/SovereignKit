...
const valid = {
  schema_version: "GrantM2OfficialPreflight@0.2.0", status: "PASS_NOT_STARTED", captured_at: "2026-09-14T04:00:00.000Z",
  ...
  transport_probe: { status: "PASS", probe_id: "transport-probe-20260914-00000000-0000-4000-8000-000000000000", captured_at: "2026-09-14T03:55:00.000Z", source_commit: source, transactions_submitted: 0, workers_started: 0, official_window_started: false, observers: ids.map(observer_id => ({ observer_id, status: "PASS", receipt_sha256: "c".repeat(64), transaction_submitted: false, worker_started: false })) },
...
test("rejects stale runtime identity, delivery backlog, active workers and resource shortfall", () => {
  for (const mutate of [
    ...
    value => { value.transport_probe.observers[1].receipt_sha256 = "invalid"; },
    value => { value.transport_probe.source_commit = "b".repeat(40); },
    value => { value.transport_probe.transactions_submitted = 1; },
    value => { value.transport_probe.captured_at = "2026-09-14T03:44:59.999Z"; },
