...
const copies = [
  ...
  ["scripts/run-grant-m2-official-transport-probe.mjs", "scripts/run-grant-m2-official-transport-probe.mjs"],
  ...
  ["scripts/lib/grant-m2-official-preflight.mjs", "scripts/lib/grant-m2-official-preflight.mjs"],
